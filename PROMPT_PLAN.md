...
- [x] Add tsconfig.json, jest.config.js, ESLint/Prettier configs
- [x] Implement src/index.ts with /health route
- [x] Add test/health.test.ts and ensure npm test passes locally
- [x] Add Dockerfile skeleton and README.md next steps
